...
namespace ParaKafe
{
    public partial class SiparisForm : Form
    {
        ...
        private event EventHandler<MasaTasindiEventArgs> MasaTasindi;
        ...
        public SiparisForm(Siparis siparis, KafeVeri db)
        {
            ...
            this.db = db;
            blDetaylar = new BindingList<SiparisDetay>(siparis.SiparisDetaylar);    // çalışma prensibi bu şekilde. tamamen senkron. burada nolursa listede de o olur.
        ...
        private void SiparisKapat(SiparisDurum durum, decimal odenenTutar)
        {
